...
- [x] OFAC Non-SDN list loaded (1.2.3)
...
- [ ] Embedding model setup (1.3.1) — no embeddings.py exists yet
- [ ] PDF extraction pipeline (1.3.2) — not started
- [ ] Text chunking strategy (1.3.3) — chunking/ dir is empty
- [ ] 20–30 enforcement PDFs chunked, embedded, and searchable (1.3.4)
- [ ] OFAC Compliance Framework + 50% Rule in vector store (1.3.5)
